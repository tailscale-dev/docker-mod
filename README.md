...
| `TAILSCALE_EXPOSE_PORT`      | The the port you would like to expose for the served container. 443 by default.                                                                                                                                                                                                                               | `443`                                    |
| `TAILSCALE_BE_EXIT_NODE`     | Whether or not to advertise as an exit node for the Tailnet.                                                                                                                                                                                                                                                  | `true`                                   |
| `TAILSCALE_ADVERTISE_ROUTES` | Subnet router routes to advertise.                                                                                                                                                                                                                                                                            | `10.0.0.0/16`                            |
| `TAILSCALE_FUNNEL`           | Set this to `true`, `1`, or `t` to enable [funnel](https://tailscale.com/kb/1243/funnel/). For more information about the accepted syntax, please read the [strconv.ParseBool documentation](https://pkg.go.dev/strconv#ParseBool) in the Go standard library.                                                | `true`                                   |
